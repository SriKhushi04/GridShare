    ...
    <div className="glass-panel rounded-lg overflow-hidden">
      ...
      <div className="divide-y divide-white/3">
        {transactions.map((tx) => {
          ...
          const StatusIcon = style.icon === 'alert' ? AlertTriangle : style.icon === 'clock' ? Clock : CheckCircle2;
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={`text-[10px] text-mono font-medium ${style.color}`}>{tx.status}</span>
              </div>
            </div>
          );
        })}
