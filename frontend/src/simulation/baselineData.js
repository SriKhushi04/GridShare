// Baseline state for RESET functionality
...
export const INITIAL_CENTRAL_BATTERY = {
  capacity: 100,
  currentEnergy: 72,
  batteryLevel: 72,
};

export const INITIAL_MAIN_GRID = {
  online: true,
  power: 0,
};
...
export const INITIAL_AI_DECISIONS = [
  {
    ...
    amount: 3.0,
    reason:
      'Building 01 has a 3.1 kW surplus with battery at 74%. P2P sharing takes priority over central battery discharge to preserve grid-level reserves.',
    result: 'COMPLETED',
    timestamp: '22:14:06',
  },
  {
    ...
    amount: 1.5,
    reason:
      'No peer building has sufficient surplus to cover Building 04 deficit. Central battery at 72% — safe to discharge. Main grid not required.',
    result: 'COMPLETED',
    timestamp: '22:08:15',
  },
];
